...
def creating_koeffs():
    ...
    # Пишемо денний файл для відправки Ірі Іщєєвій
...
def send_mail_for_sync():
    ...
    send_email(to=['omaslak@vodafone.ua'],
                ...
                <body>"""+f'''
                    ...
                    <p class="small">Іра, привіт!</p>

                    <p class="small">Прошу тебе провести синхронізацію балансів абонентам, у яких відбулись збої у зарахуванні платежів у нічний час.<br></p>
